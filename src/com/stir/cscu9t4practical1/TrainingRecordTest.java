...
//    }
    ...
    @Test
    public void testWeeklyEntry() {
        System.out.println("WeeklyEntries");
        String expectResultsNone = "No Entries Found";
        String expectResults = "Total weekly distance of Alice is 24.0m";
        TrainingRecord instance = new TrainingRecord();
        Entry a = new Entry("Alice", 31, 3, 2023, 0, 16, 7, 3);
        Entry b = new SwimEntry("Alice", 24, 3, 2023, 0, 16, 7, 3,"outdoors");
        Entry c = new SprintEntry("Alice", 25, 3, 2023, 0, 16, 7, 300 ,4,3);
        Entry d = new CycleEntry("Alice", 26, 3, 2023, 0, 16, 7, 3,"Muddy","Fast");
        Entry e = new Entry("Alice", 27, 3, 2023, 0, 16, 7, 3);
        Entry f = new SwimEntry("Alice", 28, 3, 2023, 0, 16, 7, 3, "pool");
        Entry g = new SprintEntry("Alice", 29, 3, 2023, 0, 16, 7, 300,4,3);
        Entry h = new CycleEntry("Alice", 30, 3, 2023, 0, 16, 7, 3, "Muddy", "Fast");
        instance.addEntry(a);
        instance.addEntry(b);
        instance.addEntry(c);
        instance.addEntry(d);
        ...
        //fail("This method cannot be tested as it does not exist yet");
        // un-comment the lines below when you've implemented the method
        String resultSuccess = instance.weeklyEntry("Alice");
      //   resultNone = instance.lookupEntries(d,m,1999);
      //  assertEquals(expectResultsNone,resultNone);
        assertEquals(expectResults,resultSuccess);
    }
